...
module Data.Effect.TH (
    ...
    EffectOrder (..),
    EffectConf (..),
    keyedPerformerGenConf,
    normalPerformerGenConf,
    taggedPerformerGenConf,
    PerformerFunctionConf (..),
    performerFnName,
    doesGeneratePerformerFnSignature,
    performerFnDoc,
    performerFnArgDoc,
    performerFnConfs,
    deriveHFunctor,
    noGenerateNormalPerformerFunction,
    noGenerateTaggedPerformerFunction,
    noGenerateKeyedPerformerFunction,
